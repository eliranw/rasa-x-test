...
class TechnologiesForm(FormAction):
    ...
    # Like the name function, the required_slots function is required too. As the name suggests, it configures which slots are required by the form. In addition to specifying the required slots, we’re also introducing a bit of conditional logic. 
    @staticmethod
